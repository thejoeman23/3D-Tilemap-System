...
public static class TilemapIcons
{
    ...
    private static Texture2D BoxFillIcon = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.thejoeman23.tilemap3d/BoxPaint.png");
    private static Texture2D BoxEraseIcon = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.thejoeman23.tilemap3d/BoxErase.png");
